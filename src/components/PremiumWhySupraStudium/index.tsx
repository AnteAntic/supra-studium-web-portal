    ...
    <section className="py-32 bg-stone-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-playfair font-bold text-foreground mb-6 tracking-tight">
              Više od edukacije –{" "}
              ...
              {" "}koji stvara terapeute budućnosti
            </h2>
            <p className="text-lg md:text-xl text-[#333] max-w-4xl mx-auto font-inter leading-relaxed">
