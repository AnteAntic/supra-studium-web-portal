...
const AkupresuraPage = () => {
  ...
  const courseSchedule = {
    petak: {
      ...
      content: [
        "Energetska dijagnostika i mapiranje tijela",
        "30+ ključnih akupresurnih točaka za bolna stanja",
        "Tehnike za glavobolje i migrene",
        "Terapija bolova u leđima i vratu",
        "Praktične vježbe u paru – odmah primjenjivo u praksi",
      ],
      hookBox:
        "Upoznaj 6 energetskih meridijana i nauči koristiti akupresuru za trenutačno olakšanje bola i napetosti.",
    },
    subota: {
      title: "Dan 2: Trigger-point terapija",
      subtitle: '⚡ "90 sekundi do olakšanja"',
      content: [
        "Anatomija i lokacija najvažnijih trigger pointova",
        "90-sekundna switch-off tehnika",
        "Ice & Stretch metodologija za trajne rezultate",
        "Rad s kroničnim bolnim stanjima (vrat, ramena, leđa, zdjelica, noge)",
        "Case study – praktični primjeri iz prakse",
      ],
    ...
    nedjelja: {
      ...
      content: [
        "Kombiniranje akupresure i trigger-point terapije",
        "Protokoli za glavobolje, bolove u vratu, ramenima, zdjelici i nogama",
        "Kućne vježbe i savjeti za klijente – terapija koja traje i nakon tretmana",
        "Neuromuskularno istezanje & PIR tehnike za povećanje pokretljivosti",
        "Q&A s instruktorom – razrješenje svih tvojih pitanja",
      ],
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Cijena uključuje 24 sata edukacije, certificiranje, materijale, refreshmente i pristup online materijalima.",
    },
    {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section ref={heroRef} className="relative min-h-screen overflow-hidden -mt-20">
        ...
        <div className="absolute inset-0 top-[-5rem]">
          ...
          >
            <source
              src="https://www.dropbox.com/scl/fi/zu7uftbbxjg619w0j4r2s/atpt_hero-background.mp4?rlkey=53arhybzq615h8bvnx1ewqj51&st=ym2v8jte&raw=1"
              type="video/mp4"
            />
          </video>
        </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-lg">
                ...
                >
                  <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl tracking-[-0.01em] leading-[0.9] text-center relative z-[4] px-4">
                    <span
                      className="block font-playfair font-normal text-white/90 drop-shadow-lg text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl mb-2 tracking-wide"
                      style={{
                    ...
                    <TextShimmer
                      className="font-playfair font-bold text-white drop-shadow-xl tracking-wide text-shadow-lg relative z-[4] [--base-gradient-color:#ffd700] [--base-color:#ffffff] [text-shadow:0_6px_12px_rgba(0,0,0,0.6),0_3px_6px_rgba(0,0,0,0.4),0_1px_3px_rgba(0,0,0,0.3)]"
                      duration={2.5}
                      spread={3}
                    >
                ...
                <motion.p
                  ...
                  className="text-lg md:text-xl mb-8 text-white/90 max-w-4xl mx-auto leading-relaxed text-center"
                  style={{
                    fontFamily: "Inter, sans-serif",
                    textShadow: "1px 1px 2px rgba(0,0,0,0.8)",
                  }}
                >
                  Akupresura i trigger point terapija spajaju istočnu mudrost i zapadnu preciznost. Kroz ovu edukaciju
                  naučit ćeš prepoznati i tretirati skrivene izvore boli, vratiti slobodu pokreta i pomoći tijelu da se
                  samo regenerira.
                </motion.p>
                ...
                >
                  ...
                  >
                    <Button
                      size="lg"
                      className="bg-[#d4af37] hover:bg-[#c19b2a] text-white px-8 py-4 text-lg font-bold rounded-2xl shadow-xl hover:shadow-2xl hover:shadow-[#d4af37]/30 transition-all duration-300 border-0"
                  ...
                  >
                    <Button
                      size="lg"
                      className="bg-white/10 backdrop-blur-md border-2 border-[#d4af37] text-white hover:bg-[#d4af37]/20 px-8 py-4 text-lg font-semibold rounded-2xl transition-all duration-300 hover:shadow-lg hover:shadow-[#d4af37]/25"
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-5 gap-16 items-center">
            ...
            <div className="lg:col-span-3">
              ...
              >
                Akupresura i trigger point terapija spajaju drevne istočnjačke mudrosti i moderne zapadne prakse za brzo
                i trajno rješavanje miofascijalne boli. Ne boli.
              </motion.p>
              ...
              >
                ...
                >
                  <Button
                    size="lg"
                    className="bg-[#d4af37] hover:bg-[#c19b2a] text-white px-8 py-4 text-lg font-bold rounded-2xl shadow-xl hover:shadow-2xl hover:shadow-[#d4af37]/30 transition-all duration-300 border-0 group-hover:animate-pulse"
                    onClick={scrollToPricing}
                  >
                ...
                >
                  <Button
                    variant="outline"
                    size="lg"
                    className="border-2 border-[#d4af37] text-[#d4af37] hover:bg-[#d4af37] hover:text-white px-8 py-4 text-lg font-semibold rounded-2xl transition-all duration-300 hover:shadow-lg hover:shadow-[#d4af37]/25"
                    onClick={() => setVideoModalOpen(true)}
                  >
                    Pogledaj video (0:57)
                  </Button>
              ...
              >
                <div className="relative rounded-2xl overflow-hidden shadow-2xl hover:shadow-[#d4af37]/30 transition-all duration-300 group-hover:shadow-3xl">
                  <img
                    ...
                    alt="Akupresura i Trigger Point video"
      ...
      >
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <div
              className="backdrop-blur-[12px] bg-white/70 border border-[#EADFC9] rounded-2xl p-16 shadow-xl hover:shadow-2xl transition-all duration-300"
              style={{
              ...
              <div className="grid md:grid-cols-2 gap-16 items-start">
                ...
                <div className="space-y-8">
                  <motion.h2
                    ...
                    className="text-5xl font-extrabold text-gray-900 mb-6 relative leading-tight"
                    style={{
                      fontFamily: "Playfair Display, serif",
                    }}
                  >
                  ...
                  >
                    ...
                    >
                      Čak <span className="font-bold text-[#d4af37] text-xl">85%</span> kroničnih bolova ima korijen u
                      mišićno-fascijalnim disfunkcijama. Na ovoj edukaciji naučit ćete kako prepoznati i ukloniti uzrok
                      boli kroz <span className="font-semibold text-[#d4af37]">precizan pritisak</span> i{" "}
                      <span className="font-semibold text-[#d4af37]">dijagnostiku</span>.
                    </p>
                    <p
                      className="text-base text-gray-700 leading-loose"
                      style={{
                    ...
                    >
                      Tri dana rada spojit će dvije filozofije –{" "}
                      <span className="font-semibold text-[#d4af37]">istočnu akupresuru</span> i{" "}
                      <span className="font-semibold text-[#d4af37]">zapadni trigger point</span> – u snažan pristup
                      tretiranju glavobolja, bolova u vratu, ramenima, leđima, križima, glutealnoj regiji i stopalima.
                    </p>
                  </motion.div>
                ...
                <div className="relative">
                  ...
                  >
                    <div
                      className="relative rounded-2xl overflow-hidden border-2 border-[#d4af37]/20"
                      style={{
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src="/lovable-uploads/education-workshop-bg.jpg"
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-8">
            ...
            >
              <div className="backdrop-blur-xl bg-white/75 border border-[#EADFC9] rounded-2xl p-8 h-full shadow-lg hover:shadow-xl hover:shadow-[#d4af37]/10 transition-all duration-300 hover:border-[#d4af37]/40">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Energetski obrazac 6 ključnih meridijana</h3>
            ...
            >
              <div className="backdrop-blur-xl bg-white/75 border border-[#EADFC9] rounded-2xl p-8 h-full shadow-lg hover:shadow-xl hover:shadow-[#d4af37]/10 transition-all duration-300 hover:border-[#d4af37]/40">
                <h3 className="text-xl font-bold text-gray-900 mb-3">30+ akupresurnih točaka</h3>
                <p className="text-[#d4af37] font-semibold mb-4 text-sm uppercase tracking-wide">
            ...
            >
              <div className="backdrop-blur-xl bg-white/75 border border-[#EADFC9] rounded-2xl p-8 h-full shadow-lg hover:shadow-xl hover:shadow-[#d4af37]/10 transition-all duration-300 hover:border-[#d4af37]/40">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Trigger-point '90 s switch-off' tehnika</h3>
                <p className="text-[#d4af37] font-semibold mb-4 text-sm uppercase tracking-wide">
          ...
          >
            <div className="backdrop-blur-xl bg-[#d4af37]/10 border border-[#d4af37]/30 rounded-2xl p-10 text-center shadow-xl shadow-[#d4af37]/10">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Dvostruki učinak, stvarni rezultati</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-4 max-w-4xl mx-auto">
                Ne nauči samo kako, već i zašto kombinacija akupresure i trigger točaka višestruko povećava učinkovitost
                terapije – s preciznošću i sigurnošću koju klijenti osjećaju već nakon prvog tretmana.
              </p>
              <p className="text-sm italic text-gray-600">
                Pro tip: Nakon ove trodnevne edukacije, tvoja praksa više neće biti ista – tretmani postaju jasniji,
                ciljano djeluju i donose trajne rezultate.
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              <div className="backdrop-blur-xl bg-white/75 border border-[#EADFC9] rounded-2xl p-8 h-full shadow-lg hover:shadow-xl hover:shadow-[#d4af37]/10 transition-all duration-300 hover:border-[#d4af37]/40">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Ice & Stretch metoda za trajne rezultate</h3>
                <p className="text-[#d4af37] font-semibold mb-4 text-sm uppercase tracking-wide">
            ...
            >
              <div className="backdrop-blur-xl bg-white/75 border border-[#EADFC9] rounded-2xl p-8 h-full shadow-lg hover:shadow-xl hover:shadow-[#d4af37]/10 transition-all duration-300 hover:border-[#d4af37]/40">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Neuromuskularno istezanje & PIR</h3>
                <p className="text-[#d4af37] font-semibold mb-4 text-sm uppercase tracking-wide">
            ...
            >
              <div className="backdrop-blur-xl bg-white/75 border border-[#EADFC9] rounded-2xl p-8 h-full shadow-lg hover:shadow-xl hover:shadow-[#d4af37]/10 transition-all duration-300 hover:border-[#d4af37]/40">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Kućne vježbe za klijente</h3>
                <p className="text-[#d4af37] font-semibold mb-4 text-sm uppercase tracking-wide">
          ...
          <div className="max-w-4xl mx-auto">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid w-full grid-cols-3 bg-white/60 backdrop-blur-sm border border-white/30 rounded-full p-2 shadow-lg overflow-x-auto">
                <TabsTrigger
                  value="petak"
                  className="rounded-full px-6 py-3 text-sm font-medium transition-all duration-300 data-[state=active]:bg-supra-golden data-[state=active]:text-white data-[state=active]:shadow-lg hover:bg-white/50"
                  style={{
              ...
              {Object.entries(courseSchedule).map(([day, schedule], index) => (
                <TabsContent key={day} value={day} className="mt-8">
                  ...
                  >
                    <Card
                      className="bg-white/40 backdrop-blur-[24px] border-l-4 border-l-[#D9B67B] border border-white/30 rounded-2xl overflow-hidden hover:bg-white/50 hover:scale-[1.02] transition-all duration-500"
                      style={{
                    ...
                    >
                      <CardContent className="p-8">
                        <div className="mb-6">
                          <h3
                            className="text-2xl lg:text-3xl font-bold text-[#111] mb-2"
                            style={{
                              fontFamily: "Playfair Display, serif",
                        ...
                        <motion.div
                          ...
                          className="bg-white/60 backdrop-blur-sm border-2 border-[#D9B67B] rounded-2xl p-6"
                          style={{
      ...
      <section className="relative py-24 overflow-hidden bg-[#FAF9F7]">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <h2
              className="text-5xl lg:text-6xl font-bold text-[#111] mb-6"
              style={{
                fontFamily: "Playfair Display, serif",
              }}
            >
            ...
            <p
              className="text-xl text-gray-600 font-medium max-w-4xl mx-auto"
              style={{
                fontFamily: "Inter, sans-serif",
              }}
            >
              Svaka edukacija donosi nova iskustva, praktične uvide i povezanost s kolegama – pogledajte kako izgleda
              put do terapijske izvrsnosti.
            </p>
          </motion.div>
          ...
          <div className="relative">
            ...
            <div
              ...
              aria-label="Trenuci koji ostaju"
            ...
            >
              ...
              <motion.div
                ...
                className="relative flex-shrink-0 w-80 h-64 snap-start group"
                data-card
                style={{
              ...
              >
                <img
                  src="/lovable-uploads/e933b2da-f729-436f-b2fd-e38c19eb94d9.png"
                  alt="Učenje zajedno"
                  className="w-full h-full object-cover rounded-2xl shadow-lg group-hover:shadow-xl transition-all duration-300"
                />
                <motion.div
              ...
              >
                <img
                  src="/lovable-uploads/644c3804-7b28-42bc-a9fb-b2b614e46357.png"
                  alt="Fokus i prisutnost"
                  className="w-full h-full object-cover rounded-2xl shadow-lg group-hover:shadow-xl transition-all duration-300"
                />
                <motion.div
                  initial={{
              ...
              >
                <img
                  src="/lovable-uploads/0224950f-d652-4ec1-927d-024e023727ba.png"
                  alt="Energetska dijagnostika uha"
                  className="w-full h-full object-cover rounded-2xl shadow-lg group-hover:shadow-xl transition-all duration-300"
                />
                <motion.div
                  initial={{
              ...
              >
                <img
                  src="/lovable-uploads/bf282f9f-783e-410e-86c8-4cabdf11f976.png"
                  alt="Prezentacija & praksa 1-na-1"
                  className="w-full h-full object-cover rounded-2xl shadow-lg group-hover:shadow-xl transition-all duration-300"
                />
                <motion.div
                  initial={{
            ...
            <button
              id="momentsPrev"
              className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full border-2 border-[#d4af37] bg-white/90 backdrop-blur-sm flex items-center justify-center text-[#d4af37] hover:bg-[#d4af37] hover:text-white hover:shadow-[0_0_20px_rgba(212,175,55,0.5)] transition-all duration-300 shadow-lg z-20 disabled:opacity-40 disabled:cursor-not-allowed"
            ...
            <button
              id="momentsNext"
              className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full border-2 border-[#d4af37] bg-white/90 backdrop-blur-sm flex items-center justify-center text-[#d4af37] hover:bg-[#d4af37] hover:text-white hover:shadow-[0_0_20px_rgba(212,175,55,0.5)] transition-all duration-300 shadow-lg z-20 disabled:opacity-40 disabled:cursor-not-allowed"
              aria-label="Sljedeće"
              role="button"
              tabIndex={0}
              onClick={() => {
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              >
                ...
                <div className="space-y-2">
                  <p className="text-sm font-semibold text-[#D4AF37] uppercase tracking-wide">👤 O predavaču</p>
                  <h2
                ...
                <div className="space-y-4 text-gray-700" style={{ lineHeight: "1.8" }}>
                  <p className="text-base lg:text-lg leading-loose">
                    S više od <strong className="text-[#D4AF37]">16 godina rada u manualnoj terapiji</strong>, kroz ruke
                    mi je prošlo na tisuće klijenata s kroničnim bolovima, napetošću i neuspješnim pokušajima rješenja.
                    Trigger point terapija je jedan od alata koji uvijek iznova dokazuje svoju učinkovitost – ali samo
                    kad se koristi precizno, promišljeno i s razumijevanjem cijelog sustava.
                  </p>
                  <p className="text-base lg:text-lg leading-loose">
                    Upravo zato ovaj tečaj nije "još jedan seminar o bolnim točkama".
                    <br />
                    To je strukturiran, visoko praktičan trening koji terapeutima daje samopouzdanje u radu s dubokim i
                    zahtjevnim strukturama, a pritom ne gubi dodir sa stvarnim čovjekom ispred sebe.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  <h3 className="text-lg font-bold text-[#D4AF37] flex items-center gap-2">🎯 Moja misija</h3>
                  <p className="text-base lg:text-lg text-gray-700 leading-loose">
                    Prenositi znanje koje ima smisla u praksi – ono što <strong>djeluje danas</strong>, na stvarnim
                    ljudima, u stvarnim uvjetima. Zato su moje edukacije uvijek fokusirane, konkretne i usmjerene na
                    stvarne rezultate.
                  </p>
                </div>
                ...
                >
                  <motion.div whileHover={{ scale: 1.05 }} transition={{ duration: 0.2 }} className="inline-block">
                    ...
                    >
                      <a href="#kontakt">👉 Postavi pitanje predavaču</a>
                    </Button>
                  </motion.div>
                </motion.div>
              </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="rounded-2xl p-8 bg-white shadow-lg border border-accent/20 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-center mb-6">
                    <div className="text-lg text-muted-foreground line-through mb-2">Redovna cijena: 450 €</div>
                  ...
                  <div className="text-sm text-muted-foreground text-center mb-6">
                    Prijavi se do 20.01.2026. i ulovi early bird cijenu – najbolji omjer znanja i uštede!
                  </div>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-playfair text-3xl font-bold text-foreground mb-4">Uključen paket vrijednosti:</h3>
              </div>
                ...
                {[
                  ...
                  >
                    ...
                    <p className="text-foreground text-lg leading-relaxed">
                      {benefit.text
                        .split(" – ")
                        .map((part, i) => (i === 0 ? <strong key={i}>{part}</strong> : <span key={i}> – {part}</span>))}
                    </p>
                  </motion.div>
                ))}
              </div>
          ...
          >
            <div className="max-w-md mx-auto">
              <Button
                size="lg"
                className="w-full rounded-xl bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-primary-foreground px-8 py-4 text-xl font-bold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
      ...
      <section className="py-20 bg-gradient-to-b from-[#FFFDFA] to-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="font-playfair text-4xl font-bold text-gray-900 mb-4">Što kažu naši polaznici</h2>
      ...
      <section className="py-20 bg-gradient-to-b from-[#FFFDFA] to-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl font-medium text-[#444] max-w-2xl mx-auto">Sve što trebaš znati prije prijave</p>
          </motion.div>
          ...
          >
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem
                value="item-1"
                className="bg-white border border-[#EADFC9] rounded-xl shadow-sm hover:shadow-md transition-all duration-300"
              >
                <AccordionTrigger className="px-6 py-4 text-left hover:no-underline group">
                  <div className="flex items-center gap-3">
                    <span className="text-lg font-medium text-[#222]">📍 Kada i gdje se održava tečaj?</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="px-6 pb-4">
                  <p className="text-[#444] leading-relaxed">
                    Tečaj se održava u Zagrebu od 14. do 16. studenog 2025. Lokacija je lako dostupna i osigurava ti
                    ugodnu atmosferu za učenje i praksu. Sve detalje o adresi i dolasku dobit ćeš nakon prijave.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="px-6 py-4 text-left hover:no-underline group">
                  <div className="flex items-center gap-3">
                    <span className="text-lg font-medium text-[#222]">🤔 Trebam li prethodno iskustvo?</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="px-6 pb-4">
                  <p className="text-[#444] leading-relaxed">
                    Ne! Tečaj je kreiran tako da ga mogu pratiti i potpuni početnici, ali i iskusni terapeuti. Kroz
                    praktične vježbe brzo ćeš usvojiti tehnike koje možeš odmah primijeniti.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="px-6 py-4 text-left hover:no-underline group">
                  <div className="flex items-center gap-3">
                    <span className="text-lg font-medium text-[#222]">🎓 Dobivam li certifikat?</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="px-6 pb-4">
                  <p className="text-[#444] leading-relaxed">
                    Da, po završetku edukacije dobivaš certifikat s upisom u e-radnu knjižicu, koji potvrđuje tvoje
                    znanje i dodatno jača tvoju profesionalnu vjerodostojnost.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="px-6 py-4 text-left hover:no-underline group">
                  <div className="flex items-center gap-3">
                    <span className="text-lg font-medium text-[#222]">💡 Što je uključeno u cijenu?</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="px-6 pb-4">
                  <p className="text-[#444] leading-relaxed">
                    U cijenu su uključene 24 sata praktične edukacije, PDF priručnik (99 stranica), anatomske
                    ilustracije (190 stranica), 3-mjesečno mentorstvo, te doživotni pristup svim materijalima.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              >
                <AccordionTrigger className="px-6 py-4 text-left hover:no-underline group">
                  <div className="flex items-center gap-3">
                    <span className="text-lg font-medium text-[#222]">📅 Što ako ne mogu doći jedan dan?</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="px-6 pb-4">
                  <p className="text-[#444] leading-relaxed">
                    Nema brige – dobit ćeš pristup svim materijalima i snimljenim sadržajima, tako da ništa ne
                    propuštaš. Možeš učiti svojim tempom i vratiti se na gradivo kad ti najviše odgovara.
                  </p>
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          ...
          >
            <p
              className="text-lg text-[#333333] mb-6"
              style={{
                fontFamily: "Inter, sans-serif",
              }}
            >
            ...
            <a href="#kontakt" className="inline-block">
              ...
              >
                <Button
                  size="lg"
                  className="bg-[#D4AF37] hover:bg-[#c19b2a] text-[#111111] px-8 py-4 text-lg font-bold rounded-xl shadow-lg transition-all duration-300"
                >
                  Pošalji upit
                </Button>
              </motion.div>
      ...
      <footer className="bg-[#0D0D0D] relative">
        ...
        <div className="container mx-auto px-4 py-8 relative z-10">
          <div className="text-center">
            {/* Copyright */}
            <p className="text-white/70 text-sm mb-6">© 2025 Supra Studium. Sva prava pridržana.</p>
            ...
            <div className="flex items-center justify-center gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 hover:bg-[#C8A24A] border border-white/20 hover:border-[#C8A24A] rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 group"
              >
                <svg
              ...
              <a
                href="https://www.youtube.com/@anteantic7905"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 hover:bg-[#C8A24A] border border-white/20 hover:border-[#C8A24A] rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 group"
              >
        ...
        {videoModalOpen && (
          ...
          >
            ...
            >
              ...
              <iframe
                src="https://www.youtube.com/embed/KV_BrRMPHi4?autoplay=1"
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#0A0A0A] via-[#1A1A1A] to-[#0F0F0F]">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <Button
                className="bg-[#B9975B] hover:bg-[#B9975B]/90 text-white px-8 py-3 text-lg font-semibold hover:shadow-[0_0_20px_rgba(185,151,91,0.5)] transition-all duration-300 group relative overflow-hidden shimmer-effect"
